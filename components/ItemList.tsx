    ...
    if (isSearchResult) {
       return (
        <div className="text-center py-16 px-4">
          ...
          <p className="mt-2 text-text-secondary dark:text-dark-text-secondary">Try searching with different keywords for "{searchQuery}".</p>
        </div>
      );
    }
    return (
      <div className="text-center py-16 px-4">
        ...
        <p className="mt-2 text-text-secondary dark:text-dark-text-secondary">No {itemType} items have been reported yet.</p>
      </div>
    );
  }
